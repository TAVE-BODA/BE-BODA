            ...
            case "수술" -> """
                    {
                        ...
                        "items": [
                          {
                            "coverageName": "수술 관련 보장항목명. 예: 아킬레스힘줄손상 수술비(연 1회만), 1종 수술, 2종 수술, 3종 수술, 4종 수술, 5종 수술(고도·특수), 장기이식 수술, 수술 종별 기준",
                            "amounts": [
                              {
                    ...
                    수술 카드에 포함할 수 있는 항목은 질병수술, 재해수술, 특정 부위 수술, 아킬레스힘줄손상 수술, 무릎인대파열 및 연골손상 수술, 인대 관련 수술, 장기이식 수술, 1종/2종/3종/4종/5종 수술 등입니다.
                    수술 보장은 1종/2종/3종/4종/5종 수술처럼 종별로 금액이 다른 경우가 많은데, 하나의 item으로 합치지 말고, 각 종별 수술을 별도의 item으로 분리해 주세요.
                    예를 들어 "1종 수술", "2종 수술", "3종 수술", "장기이식 수술"은 각각 다른 item으로 생성해 주세요.
                    
                    단, "재해골절 수술", "골절 수술", "재해골절수술보험금"처럼 골절이 핵심인 수술 보장은 수술 카드에 포함하지 말고 골절·재해 카드로 분류해야 합니다.
                    따라서 해당 항목은 수술 카드의 items에 포함하지 마세요.
                    
                    그리고 수술, 입원, 진단, 치아 치료, 실손의료비, 사망, 후유장해, 연금, 자동차, 저축성, 해지환급금 관련 내용 중 수술 지급 사유가 아닌 항목은 수술 카드에서 제외해 주세요.
                    ...
                    같은 item 안에서는 동일한 condition이 중복되지 않도록 해 주세요.
                    만약 같은 기간 조건 안에서 질병/재해/원인에 따라 coverageAmount가 달라진다면, 하나의 item에 넣지 말고 coverageName을 나누어 별도의 item으로 저장해 주세요.
                    
                    예를 들어 증권에 아래와 같이 적혀 있다면:
                    - 계약일부터 1년 초과: 70,000원
                    - 계약일부터 1년 이내 (재해로 인하여 발생한 수술보험금의 경우): 70,000원
                    - 계약일부터 1년 이내 (재해 이외의 원인으로 인하여 발생한 수술보험금의 경우): 35,000원
                    ...
                    `condition`은 기간 기준으로만 작성해 주세요. '계약일부터'의 명칭은 필요없으니 "1년 이내", "1년 초과", "조건없음"처럼 기간만 넣어 주세요.`condition`에 들어가는 기간/조건명에서 "계약일부터"라는 문구는 제거해 주세요.
                    예를 들어 "계약일부터 1년 이내"는 "1년 이내"로, "계약일부터 1년 초과"는 "1년 초과"로 작성해 주세요.
                    그리고 "연간 1회만"처럼 제한 조건은 `condition`에 적지 않고 `coverageName`에 괄호를 통해 작성해주세요.
                    
                    마지막으로, 수술 종별 기준표가 증권에 없고 약관 확인이 필요한 경우에는 coverageName을 "수술 종별 기준"으로 하는 item을 추가해 주세요.
                    이 경우 condition에는 "약관이 필요해요"를 넣고, coverageAmount에는 null을 넣어 주세요!!!
                    예를 들면 아래와 같아요!
                    [{"amounts": [{"condition": "약관이 필요해요", "coverageAmount": null}], "coverageName": "수술 종별 기준"}
